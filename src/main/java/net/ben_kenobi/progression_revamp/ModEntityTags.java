...
public class ModEntityTags {
    public static final TagKey<EntityType<?>> DISCHARGE_ETHERAL_SWORD_ON_KILL = TagKey.of(RegistryKeys.ENTITY_TYPE, new Identifier(ProgressionRevamp.MOD_ID, "discharge_etheral_sword_on_kill"));
